...
public class ARE_ToolItem_Subscript extends ARE_ToolItem_Abstract {
    ...
    public ARE_ToolItem_Subscript(int activeImage, int inActiveImage) {
    ...
    public IARE_Style getStyle() {
        if (mStyle == null) {
            ...
            mStyle = new ARE_Style_Subscript(editText, (ImageView) mToolItemView, toolItemUpdater, activeImage, inActiveImage);
        }
        return mStyle;
    }
