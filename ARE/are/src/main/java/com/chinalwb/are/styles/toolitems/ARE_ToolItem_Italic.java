...
public class ARE_ToolItem_Italic extends ARE_ToolItem_Abstract {
    ...
    public ARE_ToolItem_Italic(int activeImage, int inActiveImage) {
    ...
    public IARE_Style getStyle() {
        if (mStyle == null) {
            ...
            mStyle = new ARE_Style_Italic(editText, (ImageView) mToolItemView, toolItemUpdater, activeImage, inActiveImage);
        }
        return mStyle;
    }
